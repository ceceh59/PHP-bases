...
<a href="php_get.php?nom=test">Passer paramètre nom</a>
<br>
<a href="php_get.php?ville=valenciennes">Passer paramètre ville</a>
<br>
<a href="php_get.php?ville=valenciennes&nom=fab">Passer paramètres nom et ville</a>
<br>
<?php
...
if (isset($_GET['chiffre'])) {
    // intvall force la conversion en type entier de la valeur passée
    //les chaines de caratcere sont donc converties en 0
    // toto est converti en 0
    //423toto est converti en 123
    $chiffre = intval($_GET['chiffre']);

    //si on ta tapé du texte ou le chiffre 0
    // on ne calcule de table de multiplication
    if ($chiffre == 0) {
        echo "veuiller saisir un chiffre supérieur à zero, CONNARD!!!";
    }
